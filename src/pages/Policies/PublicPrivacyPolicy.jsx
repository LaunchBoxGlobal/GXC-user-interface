  ...
  return (
    <div className="w-full relative padding-x py-20">
      ...
      <div className="w-full">
        ...
        <p className="">
          giveXchange will collect End User Data necessary to provide the
          giveXchange services to our customers.
        </p>
        <p className="">
        ...
        <p className="">
          ...
          interest in becoming a giveXchange customer, we receive information
          from a third party that provides automated fraud detection services to
          giveXchange. We also occasionally collect information that is made
        ...
        <p className="">
          giveXchange will collect personal information that you submit to us.
        ...
        <p className="">
          ...
          giveXchange to you and fulfill the purposes described in this policy.
        ...
        <p className="">
          ...
          absolute security of any information you transmit to giveXchange or
        ...
        <p className="">
          giveXchange is incorporated in United States. Information collected
        ...
        <p className="">
          ...
          information giveXchange collects depend on your relationship with
          giveXchange. Personnel may update or correct their information as
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Personnel</h3>
        <p className="">
          If you are a giveXchange worker or applicant, we collect information
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Sale of Business</h3>
        <p className="">
          ...
          of the assets of giveXchange or any of its Corporate Affiliates (as
          defined herein), or that portion of giveXchange or any of its
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Affiliates</h3>
        <p className="">
          ...
          giveXchange, whether by ownership or otherwise. Any information
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Governing Law</h3>
        <p className="">
          ...
          under Privacy Shield, or the Swiss-US framework. The laws of United
          States, excluding its conflicts of law rules, shall govern this
          Agreement and your use of the website/app. Your use of the website/app
          may also be subject to other local, state, national, or international
          laws. By using giveXchange or contacting us directly, you signify your
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Your Consent</h3>
        <p className="">
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Advertising</h3>
        <p className="">
          This website/app may contain third party advertisements and links to
          third party sites. giveXchange does not make any representation as to
          ...
          sites and the offerings made by the third parties. Advertising keeps
          giveXchange and many of the websites and services you use free of
          charge. We work hard to make sure that ads are safe, unobtrusive, and
          as relevant as possible. Third party advertisements and links to other
          sites where goods or services are advertised are not endorsements or
          recommendations by giveXchange of the third party sites, goods or
          services. giveXchange takes no responsibility for the content of any
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Cookies</h3>
        <p className="">
          giveXchange uses "Cookies" to identify the areas of our website that
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Payment Details</h3>
        <p className="">
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Kids' Privacy</h3>
        <p className="">
        ...
        <p className="">
          ...
          ("Third- Party Services"). You acknowledge and agree that giveXchange
          ...
          legality, decency, quality or any other aspect thereof. giveXchange
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">What is GDPR?</h3>
        <p className="">
        ...
        <p className="">
          ...
          right thing to do. At giveXchange we strongly believe that your data
        ...
        <p className="">
          ...
          requirements of GDPR. giveXchange processes or stores all personal
          ...
          longer than 60 days. We are aware that if you are working with EU
        ...
        <p className="">CalOPPA users have the following rights:</p>
        <ul className="space-y-2 mt-2">
          {[
            "Right to Know and Access. You may submit a verifiable request for information regarding the: (1) categories of Personal Information we collect, use, or share; (2) purposes for which categories of Personal Information are collected or used by us; (3) categories of sources from which we collect Personal Information; and (4) specific pieces of Personal Information we have collected about you.",
            "Right to Equal Service. We will not discriminate against you if you exercise your privacy rights.",
        ...
        <h3 className="font-semibold text-xl mt-4 mb-2">Contact Us</h3>
        <p className="">
