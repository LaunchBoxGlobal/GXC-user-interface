...
const PublicTermsConditions = () => {
  return (
    <div className="w-full relative padding-x py-20">
      ...
      <div className="w-full">
        <h2 className="font-semibold text-xl mt-4 mb-2">General Terms</h2>
        <p>
          By accessing and placing an order with giveXchange, you confirm that
        ...
        <p>
          Under no circumstances shall giveXchange team be liable for any
          ...
          giveXchange team or an authorized representative has been advised of
        ...
        <p>
          giveXchange will not be responsible for any outcome that may occur
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">License</h2>
        <p>
          giveXchange grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the website/app strictly
          in accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms & Conditions are a contract between you and giveXchange
          (referred to in these Terms & Conditions as "giveXchange", "us", "we"
          or "our"), the provider of the giveXchange website and the services
          accessible from the giveXchange website (which are collectively
          referred to in these Terms & Conditions as the "giveXchange Service").
        </p>
        <p>
          ...
          giveXchange Service. In these Terms & Conditions, "you" refers both to
        ...
        <ul className="space-y-2 mt-2">
          ...
          <li>
            ...
            “us,” or “our,” it refers to giveXchange LLC, (5204 Mitchell St.
            Alexandria, VA 22312), that is responsible for your information
            under this Terms & Conditions.
          </li>
          <li>
            <strong>Country:</strong> where giveXchange or the owners/founders
            of giveXchange are based, in this case is United States
          </li>
          <li>
            ...
            visit giveXchange and use the services.
          </li>
          <li>
            <strong>Service:</strong> refers to the service provided by
            giveXchange as described in the relative terms (if available) and on
            this platform.
          </li>
          <li>
          ...
          <li>
            ...
            giveXchange to use the Services.
          </li>
        </ul>

        <h2 className="font-semibold text-xl mt-4 mb-2">Restrictions</h2>
        <p>You agree not to, and you will not permit others to:</p>
        <ul className="space-y-2 mt-2">
          <li>
            <strong>License,</strong> sell, rent, lease, assign, distribute,
            transmit, host, outsource, disclose or otherwise commercially
            exploit the website/app or make the platform available to any third
            party.
          </li>
          <li>
            <strong>Modify,</strong> make derivative works of, disassemble,
            decrypt, reverse compile or reverse engineer any part of the
            website/app.
          </li>
          <li>
            <strong>Remove,</strong> alter or obscure any proprietary notice
            (including any notice of copyright or trademark) of giveXchange or
            its affiliates, partners, suppliers or the licensors of the
            website/app.
          </li>
        </ul>

        <h2 className="font-semibold text-xl mt-4 mb-2">Payment</h2>
        <p>
          ...
          giveXchange with your credit card number and associated payment
          information, you agree that giveXchange is authorized to verify
          information immediately, and subsequently invoice your account for all
          fees and charges due and payable to giveXchange hereunder and that no
          additional notice or consent is required. You agree to immediately
          notify giveXchange of any change in your billing address or the credit
          card used for payment hereunder. giveXchange reserves the right at any
        ...
        <p>
          No contract will exist between you and giveXchange for the Service
          until giveXchange accepts your order by a confirmatory e-mail, SMS/MMS
        ...
        <p>
          Thanks for shopping at giveXchange. We appreciate the fact that you
        ...
        <p>
          ...
          apply to transactions at giveXchange. We’ll be as brief as our
          attorneys will allow. The main thing to remember is that by placing an
          order or making a purchase at giveXchange, you agree to the terms
          along with giveXchange’s Privacy Policy.
        </p>
        <p>
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Your Suggestions</h2>
        <p>
          Any feedback, comments, ideas, improvements or suggestions
          (collectively, "Suggestions") provided by you to giveXchange with
          respect to the website/app shall remain the sole and exclusive
          property of giveXchange.
        </p>
        <p>
          giveXchange shall be free to use, copy, modify, publish, or
          redistribute the Suggestions for any purpose and in any way without
          any credit or any compensation to you.
        </p>

        <h2 className="font-semibold text-xl mt-4 mb-2">Your Consent</h2>
        <p>
        ...
        <p>
          ...
          giveXchange. We are not responsible for the content, accuracy or
        ...
        <p>
          giveXchange uses "Cookies" to identify the areas of our website/app
          ...
          access functionality on our website/app correctly or at all. We never
        ...
        <p>
          You acknowledge and agree that giveXchange may stop (permanently or
          temporarily) providing the Service (or any features within the
          Service) to you or to users generally at giveXchange’s sole
          discretion, without prior notice to you. You may stop using the
          Service at any time. You do not need to specifically inform
          giveXchange when you stop using the Service. You acknowledge and agree
          that if giveXchange disables access to your account, you may be
        ...
        <p>
          giveXchange reserves the right to modify, suspend or discontinue,
        ...
        <p>
          giveXchange may from time to time provide enhancements or improvements
          to the features/ functionality of the website/app, which may include
        ...
        <p>
          ...
          of the website/app. You agree that giveXchange has no obligation to
        ...
        <p>
          You acknowledge and agree that giveXchange shall not be responsible
          ...
          or any other aspect thereof. giveXchange does not assume and shall not
        ...
        <p>
          giveXchange may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          giveXchange, in the event that you fail to comply with any provision
        ...
        <p>
          Termination of this Agreement will not limit any of giveXchange's
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Indemnification</h2>
        <p>
          You agree to indemnify and hold giveXchange and its parents,
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">No Warranties</h2>
        <p>
          ...
          extent permitted under applicable law, giveXchange, on its own behalf
          ...
          foregoing, giveXchange provides no warranty or undertaking, and makes
          no representation of any kind that the website/app will meet your
          requirements, achieve any intended results, be compatible or work with
          any other software, website/apps, systems or services, operate without
        ...
        <p>
          Without limiting the foregoing, neither giveXchange nor any
          giveXchange's provider makes any representation or warranty of any
          kind, express or implied: (i) as to the operation or availability of
          the website/app, or the information, content, and materials or
          products included thereon; (ii) that the website/app will be
          ...
          website/app; or (iv) that the website/app, its servers, the content,
          or e-mails sent from or on behalf of giveXchange are free of viruses,
        ...
        <p>
          ...
          of giveXchange and any of its suppliers under any provision of this
        ...
        <p>
          ...
          giveXchange or its suppliers be liable for any special, incidental,
          ...
          connection with any provision of this Agreement), even if giveXchange
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Severability</h2>
        <p>
        ...
        <p>
          ...
          notices published by giveXchange on the Services, shall constitute the
          entire agreement between you and giveXchange concerning the Services.
          ...
          term or any other term, and giveXchange’s failure to assert any right
          or provision under this Agreement shall not constitute a waiver of
          such right or provision. YOU AND giveXchange AGREE THAT ANY CAUSE OF
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Waiver</h2>
        <p>
        ...
        <p>
          giveXchange reserves the right, at its sole discretion, to modify or
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Entire Agreement</h2>
        <p>
          The Agreement constitutes the entire agreement between you and
          giveXchange regarding your use of the website/app and supersedes all
        ...
        <p>
          ...
          you use or purchase other giveXchange's services, which giveXchange
        ...
        <p>
          ...
          arrangement thereof), are owned by giveXchange, its licensors or other
          ...
          giveXchange, unless and except as is expressly provided in these Terms
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR giveXchange’s
          INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and giveXchange concerning
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Notice of Dispute</h2>
        <p>
          In the event of a dispute, you or giveXchange must give the other a
          ...
          <strong>hello@thegivexchange.com</strong>. giveXchange will send any
          Notice of Dispute to you by mail to your address if we have it, or
          otherwise to your email address. You and giveXchange will attempt to
          ...
          days, you or giveXchange may commence arbitration.
        </p>

        <h2 className="font-semibold text-xl mt-4 mb-2">Binding Arbitration</h2>
        <p>
          If you and giveXchange don’t resolve any dispute by informal
        ...
        <p>
          ...
          and will become the sole property of giveXchange without any
          compensation or credit to you whatsoever. giveXchange and its
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Promotions</h2>
        <p>
          giveXchange may, from time to time, include contests, promotions,
        ...
        <h2 className="font-semibold text-xl mt-4 mb-2">Miscellaneous</h2>
        <p>
          ...
          representative of giveXchange. giveXchange will be entitled to
          ...
          breach by you. giveXchange operates and controls the giveXchange
          Service from its offices in United States. The Service is not intended
          ...
          giveXchange Service from other locations do so on their own initiative
          ...
          include and incorporate the giveXchange Privacy Policy) contains the
          entire understanding, and supersedes all prior understandings, between
          you and giveXchange concerning its subject matter, and cannot be
        ...
        <p>
          giveXchange is not responsible for any content, code or any other
          imprecision. giveXchange does not provide warranties or guarantees.
        </p>
        <p>
          In no event shall giveXchange be liable for any special, direct,
        ...
        <p className="">
          The giveXchange Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. giveXchange is a distributor and not a
          publisher of the content supplied by third parties; as such,
          giveXchange exercises no editorial control over such content and makes
          ...
          through or accessible via the giveXchange Service. Without limiting
          the foregoing, giveXchange specifically disclaims all warranties and
          representations in any content transmitted on or in connection with
          the giveXchange Service or on sites that may appear as links on the
          giveXchange Service, or in the products provided as a part of, or
          otherwise in connection with, the giveXchange Service, including
          without limitation any warranties of merchantability, fitness for a
          particular purpose or non-infringement of third party rights. No oral
          advice or written information given by giveXchange or any of its
          ...
          change without notice. Without limiting the foregoing, giveXchange
          does not warrant that the giveXchange Service will be uninterrupted,
          uncorrupted, timely, or error-free.
        </p>

        <h2 className="font-semibold text-xl mt-4 mb-2">Contact Us</h2>
        <p>Don't hesitate to contact us if you have any questions.</p>
        <p>Via Email: hello@thegivexchange.com</p>
        <p>
          Via this Link:{" "}
          <a href="https://thegivexchange.com/#contact" target="_blank">
            https://thegivexchange.com/#contact
          </a>
        </p>
      </div>
    </div>
