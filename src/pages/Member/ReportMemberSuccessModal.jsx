const ReportMemberSuccessModal = ({
  ...
  return (
    openReportMemberSuccessModal && (
      ...
      >
        <div className="w-full bg-white max-w-[471px] rounded-[16px] lg:rounded-[32px] p-7 lg:py-9 flex flex-col items-center gap-4">
...
export default ReportMemberSuccessModal;
